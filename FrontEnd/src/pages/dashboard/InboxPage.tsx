    ...
    <div className="pageTemplate2">
      ...
      <div className="pageTemplate3 items-stretch">
        <div className="grid grid-cols-6 p-2 border-2 border-gray-200 rounded-lg">
          <span>Date</span>
          <span>Type</span>
          <span className="col-spna-4">Text</span>
          <span>Sender</span>
          <span>Receiver</span>
        </div>
        {
          message.map((item) => (
            <div key={item.id} className="grid grid-cols-6 p-2 border-2 border-gray-200 rounded-lg">
              ...
              <span className="col-spna-4">{item.text}</span>
